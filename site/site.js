(() => {
  ...
  const translations = {
    en: {
      ...
      step4Body: "Complete the storybook atlas and Itsees celebrates your days, postcards, and keepsakes before opening the real world.",
    ...
    zh: {
      ...
      heroBody: "当你专注于手边的事，小伙伴会走进童话路线与真实地点。一起走完第一本图鉴后，Itsees 会用你们收藏的一切写成换章仪式，再打开真实世界。",
      download: "下载",
      ...
      step4Title: "欢迎伙伴回家",
      step4Body: "走完童话图鉴后，Itsees 会纪念相伴天数、明信片与纪念品，再为你打开真实世界。",
